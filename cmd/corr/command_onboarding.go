...
func selectOnboardingServices(
	...
	if err := writeOnboardingPendingServices(app, plan); err != nil {
...
func onboardingServiceOptions(plan onboardingRoutePlan) []huh.Option[onboardingService] {
