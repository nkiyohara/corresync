...
// OAuth application. Gmail API and Google Calendar code may ship and receive
// synthetic coverage while every released route stays unreachable.
...
var ErrGoogleOAuthPending = errors.New(
	"corresync's Google OAuth application is awaiting approval; this release " +
		...
		"sign-in was started. Gmail and Google Calendar support are coming soon " +
		"after approval",
)
