(function (root, factory) {
  ...
  const routeCapabilities = Object.freeze({
    ...
    google: Object.freeze({
      mail: "Typed Gmail API operations with your Desktop OAuth client",
      calendar: "Selectable calendars and provider-supported Google Meet links",
    }),
    jmap: Object.freeze({
  ...
  const signInNames = Object.freeze({
    ...
    user_owned_oauth: "Your Desktop OAuth client; its credential and grant stay in the OS keyring",
  ...
  const statusCopy = Object.freeze({
    ...
    not_available: {
      glyph: "…",
      title: "This route is not active in this build.",
      body: "Install a build that includes the route, then review its setup and authorization requirements before connecting an account.",
    },
    unknown: {
      glyph: "?",
  ...
  const japaneseCopy = Object.freeze({
    ...
    signInNames: Object.freeze({
      ...
      user_owned_oauth: "自分のデスクトップOAuthクライアント。認証情報と認可はOSキーチェーンに保存",
    ...
    statusCopy: Object.freeze({
      ...
      not_available: { glyph: "…", title: "このビルドでは利用できない経路です。", body: "その経路を含むビルドを導入し、アカウントをつなぐ前に設定と認可の条件を確認してください。" },
    ...
    routeCapabilities: Object.freeze({
      ...
      google: { mail: "自分のデスクトップOAuthクライアントで使う、型付きGmail API操作", calendar: "選択できるカレンダーと、プロバイダー対応時のGoogle Meetリンク" },
    ...
    serverText: Object.freeze({
      ...
      "Create a Desktop OAuth client in a Google Cloud project you control.": "自分で管理するGoogle CloudプロジェクトにデスクトップOAuthクライアントを作成してください。",
      "Enable the Gmail, Calendar, and any selected Tasks APIs.": "Gmail、Calendar、選択した場合はTasks APIを有効にしてください。",
      "Synthetic-contract covered and live-unobserved.": "合成契約テスト済みで、実環境では未観測です。",
      "Corresync-managed Google OAuth remains disabled.": "Corresync管理版のGoogle OAuthは引き続き無効です。",
      "Google testing-mode and organization policy can limit authorization lifetime or access.": "Googleのテストモードや組織ポリシーにより、認可の有効期間やアクセスが制限される場合があります。",
  ...
  const simplifiedChineseCopy = Object.freeze({
    ...
    signInNames: Object.freeze({
      ...
      user_owned_oauth: "使用你自己的桌面 OAuth 客户端；客户端凭据与授权保存在系统钥匙串",
    ...
    statusCopy: Object.freeze({
      ...
      not_available: { glyph: "…", title: "此版本未启用这条路径。", body: "请安装包含该路径的版本，并在连接账号前查看其设置与授权要求。" },
    ...
    routeCapabilities: Object.freeze({
      ...
      google: { mail: "使用你的桌面 OAuth 客户端执行类型明确的 Gmail API 操作", calendar: "可选择日历，并在服务支持时使用 Google Meet 链接" },
    ...
    serverText: Object.freeze({
      ...
      "Create a Desktop OAuth client in a Google Cloud project you control.": "请在你自己管理的 Google Cloud 项目中创建桌面 OAuth 客户端。",
      "Enable the Gmail, Calendar, and any selected Tasks APIs.": "请启用 Gmail、Calendar，以及所选服务需要的 Tasks API。",
      "Synthetic-contract covered and live-unobserved.": "已通过合成契约测试，尚未进行实机观察。",
      "Corresync-managed Google OAuth remains disabled.": "Corresync 管理的 Google OAuth 仍保持关闭。",
      "Google testing-mode and organization policy can limit authorization lifetime or access.": "Google 测试模式与组织政策可能限制授权有效期或访问。",
  ...
  const traditionalChineseCopy = Object.freeze({
    ...
    signInNames: Object.freeze({
      ...
      user_owned_oauth: "使用你自己的桌面 OAuth 用戶端；用戶端認證資料與授權保存在系統鑰匙圈",
    ...
    statusCopy: Object.freeze({
      ...
      not_available: { glyph: "…", title: "此版本未啟用這條路徑。", body: "請安裝包含該路徑的版本，並在連結帳號前查看其設定與授權要求。" },
    ...
    routeCapabilities: Object.freeze({
      ...
      google: { mail: "使用你的桌面 OAuth 用戶端執行型別明確的 Gmail API 操作", calendar: "可選擇行事曆，並在服務支援時使用 Google Meet 連結" },
    ...
    serverText: Object.freeze({
      ...
      "Create a Desktop OAuth client in a Google Cloud project you control.": "請在你自行管理的 Google Cloud 專案中建立桌面 OAuth 用戶端。",
      "Enable the Gmail, Calendar, and any selected Tasks APIs.": "請啟用 Gmail、Calendar，以及所選服務需要的 Tasks API。",
      "Synthetic-contract covered and live-unobserved.": "已通過合成契約測試，尚未進行實機觀察。",
      "Corresync-managed Google OAuth remains disabled.": "Corresync 管理的 Google OAuth 仍保持關閉。",
      "Google testing-mode and organization policy can limit authorization lifetime or access.": "Google 測試模式與組織政策可能限制授權有效期或存取。",
  ...
  const koreanCopy = Object.freeze({
    ...
    signInNames: Object.freeze({
      ...
      user_owned_oauth: "직접 소유한 데스크톱 OAuth 클라이언트, 클라이언트 자격 증명과 권한은 운영체제 키체인에 보관",
    ...
    statusCopy: Object.freeze({
      ...
      not_available: { glyph: "…", title: "이 빌드에서는 해당 경로가 활성화되지 않았습니다.", body: "해당 경로가 포함된 빌드를 설치한 뒤 계정을 연결하기 전에 설정과 권한 요건을 확인하세요." },
    ...
    routeCapabilities: Object.freeze({
      ...
      google: { mail: "직접 소유한 데스크톱 OAuth 클라이언트로 사용하는 명확히 정의된 Gmail API 작업", calendar: "캘린더 선택과 서비스가 지원하는 Google Meet 링크" },
    ...
    serverText: Object.freeze({
      ...
      "Create a Desktop OAuth client in a Google Cloud project you control.": "직접 관리하는 Google Cloud 프로젝트에 데스크톱 OAuth 클라이언트를 만드세요.",
      "Enable the Gmail, Calendar, and any selected Tasks APIs.": "Gmail, Calendar, 선택한 경우 Tasks API를 활성화하세요.",
      "Synthetic-contract covered and live-unobserved.": "합성 계약 테스트를 통과했지만 아직 실제 환경에서는 관찰하지 않았습니다.",
      "Corresync-managed Google OAuth remains disabled.": "Corresync가 관리하는 Google OAuth는 계속 비활성 상태입니다.",
      "Google testing-mode and organization policy can limit authorization lifetime or access.": "Google 테스트 모드와 조직 정책에 따라 권한 유효 기간이나 액세스가 제한될 수 있습니다.",
